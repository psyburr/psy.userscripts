// ==UserScript==
// @name        CosmosisT's TinyChat Script (CTS V1.7.16)
// @version     1.7.16
...
(function() {
    ...
    function Discord() {
        ...
        element.setAttribute("title", "CTS public chat");
        element.setAttribute("class", "chat-button");
        ChatLogElement.querySelector("#chat-wrapper").appendChild(element);
    ...
    function DiscordToggle() {
        CTS.Discord = !CTS.Discord;
        ChatLogElement.querySelector(".chat-discord").style.visibility = ((CTS.Discord) ? "visible" : "hidden");
    }
